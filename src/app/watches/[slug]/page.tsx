...
export default function WatchDetailPage({ params }: WatchDetailPageProps) {
  ...
  const watch = watches.find(w => 
    w.name.toLowerCase().replace(/[^a-z0-9]+/g, '-') === params.slug
  );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <button className="flex-1 bg-amber-500 hover:bg-amber-600 text-white py-4 px-6 rounded-lg font-semibold text-lg transition-colors flex items-center justify-center">
